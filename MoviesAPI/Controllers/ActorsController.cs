...
namespace MoviesAPI.Controllers
{
    ...
    public class ActorsController: ControllerBase
    {
        ...
        public async Task<ActionResult<List<ActorDTO>>> Get([FromQuery] PaginationDTO paginationDTO)
        {
            ...
            var actors = await queryable.OrderBy(z => z.Name).Paginate(paginationDTO).ToListAsync();
        ...
        {
            var actor = await context.Actors.FirstOrDefaultAsync(z => z.Id == id);
        ...
        public async Task<ActionResult<List<ActorsMoviesDTO>>> SearchByName([FromBody] string name)
        {
            if (string.IsNullOrEmpty(name))
            {
                return new List<ActorsMoviesDTO>();
            }

            return await context.Actors
                .Where(z => z.Name.Contains(name))
                .OrderBy(z => z.Name)
                .Select(z => new ActorsMoviesDTO { Id = z.Id, Name = z.Name, Picture = z.Picture })
                .Take(5)
                .ToListAsync();
        }
